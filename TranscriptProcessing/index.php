<?php
require_once('includes/init.php'); // Adjust path as per your project structure
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($errors)) {
        ...
        $users = authenticate($username, $password, $role, $conn); // Assuming $conn is your database connection
